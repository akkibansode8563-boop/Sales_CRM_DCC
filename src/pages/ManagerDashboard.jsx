  ...
  return (
    <div className="mgr-app">
      ...
      <nav className="tab-bar">
        {[{id:'home',ico:'🏠',lbl:'Home'},{id:'visits',ico:'📍',lbl:'Visits'},{id:'customers',ico:'🏪',lbl:'Customers'},{id:'reports',ico:'📊',lbl:'Reports'},{id:'products',ico:'📦',lbl:'Products'},{id:'profile',ico:'👤',lbl:'Profile'}].map(t=>(
